<div class="faixa">Atum</div>
<hr/>
<div class="produto">
    <div class="imagem">
        <img src="assets/img/atum.jpg">
    </div>
    <div class="detalhes">
        <br>
        <h2>a partir de R$ 20,00</h2><br><br>
        
        <p><em>Ingredientes: Mussarela com atum, cebola, azeitona preta e orégano.</em></p>
        <br>
<form action="checkout.php" method="get">
    <div>
        <legend>Escolha o tamanho:</legend>
        <input type="hidden" name="nome" value="Pizza Sabor Atum">
