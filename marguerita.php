<div class="faixa">Marguerita</div>
<hr/>
<div class="produto">
    <div class="imagem">
        <img src="assets/img/marguerita.jpg">
    </div>
    <div class="detalhes">
        <br>
        <h2>a partir de R$ 20,00</h2><br><br>
        
        <p><em>Ingredientes: Mussarela com tomate e manjericão.</em></p>
        <br>
        <form action="checkout.php" method="get">
    <div>
        <legend>Escolha o tamanho:</legend>
        <input type="hidden" name="nome" value="Pizza Sabor Marguerita">
