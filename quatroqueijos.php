<div class="faixa">Quatro Queijoss</div>
<hr/>
<div class="produto">
    <div class="imagem">
        <img src="assets/img/4queijos.jpeg">
    </div>
    <div class="detalhes">
        <br>
        <h2>a partir de R$ 25,00</h2><br><br>
        
        <p><em>Ingredientes: Provolone, Gorgonzola, Parmesão e Mussarela.</em></p>
        <br>
        <form action="checkout.php" method="get">
    <div>
        <input type="hidden" name="nome" value="Pizza Sabor Quatro Queijos">
